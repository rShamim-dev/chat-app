<div>
    <div style="overscroll-behavior: none;">
        <div class="fixed w-full bg-purple-500 h-16 pt-2 text-white flex justify-between shadow-md"
                ...
                @else
                    <div class="clearfix w-4/4">
                        <div class="text-right ">
                            <p class="bg-purple-400  mx-4 my-2 p-2 rounded-lg inline-block">{{ $message['message'] }}
                            </p>
                        </div>
                    </div>
                @endif
    ...
    <form action="" wire:submit.prevent="sendMessage">
        <div class="fixed w-full flex justify-between bg-purple-200" style="bottom: 0px;">
            ...
            <button class="m-2" style="outline: none;">
                <svg class="svg-inline--fa text-purple-500 fa-paper-plane fa-w-16 w-12 h-12 py-2 mr-2"
